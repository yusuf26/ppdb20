        ...
        <div class="main-wrapper container">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped" id="sortable-table">
                                                ...
                                                <tbody class="ui-sortable">
                                                    <?php $query = mysqli_query($koneksi, "select * from daftar group by jenis");
                                                    while ($sekolah = mysqli_fetch_array($query)) {
                                                        $hitung = rowcount($koneksi, 'daftar', ['jenis' => $sekolah['jenis']]);
                                                    ?>
                                                        <tr>
                                                            <td>
            ...
            <footer class="main-footer">
                ...
                <div class="footer-right">
					 DEVELOPER <a href="https://wa.me/6285265583929">SENJA WEB</a>
                </div>
            </footer>
        </div>
    </div>
