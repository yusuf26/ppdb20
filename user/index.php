...
?>
  ...
  <head>
    ...
    <title><?= $siswa['nama'] ?> &mdash; PPDB</title>
      ...
      <div class="main-wrapper main-wrapper-1">
          ...
          <ul class="navbar-nav navbar-right">
            ...
            <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                 <?php if ($siswa['file_foto'] != '' ) { 
                        echo '<img alt="image" src="mod_formulir/images_siswa/'.$siswa['file_foto'].'" class="rounded-circle author-box-picture">';
                    }else{
                        echo ' <img alt="image" src="../assets/img/avatar/avatarr.png" class="rounded-circle author-box-picture">';
                    } ?>
        ...
        <footer class="main-footer">
          <div class="footer-left">
            Copyright &copy; <?= date('Y') ?> <?=$setting['nama_sekolah'];?> <div class="bullet"></div>
          </div>
