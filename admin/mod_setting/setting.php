<form id="form-setting">
    <div class="card" id="settings-card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row align-items-center">
                <label for="tglbuka" class="form-control-label col-sm-3 text-md-right">tanggal buka PPDB</label>
                <div class="col-sm-6 col-md-9">
                    <input type="text" name="tgl_pembukaan" class="form-control" value="<?= $setting['tgl_pembukaan'] ?> " placeholder="YYYY-MM-DD HH:MM:SS">
                </div>
            </div>
        </div>
